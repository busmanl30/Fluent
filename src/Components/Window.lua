...
--local buttonVisible = true -- Variable to track button visibility
...
return function(Config)
	...
	function Window:Minimize()
		...
		Library.button.Modal = not Window.Minimized
		if not Window.Minimized then
			task.spawn(function()
                ...
                while not Window.Minimized and Library.GUI.Parent do
